...
int scheduling_priority_other=0,scheduling_priority_rr=4,scheduling_priority_fifo=4;
...
int main()
{
    for(int k=5;k<11;k++)
    {
       ...
       if(time3<time1 && time3<time2)
       {
        ...
        printf("[%d] ", scheduling_priority_other);
        ...
        printf("[%d]", scheduling_priority_rr);
        ...
        printf("[%d] ", scheduling_priority_fifo);
